...
@override
int get hashCode => Object.hash(runtimeType,password,email,emailVisibility,verified,name,avatar,const DeepCollectionEquality().hash(roles),const DeepCollectionEquality().hash(rolesRemovals),const DeepCollectionEquality().hash(rolesPrefix),const DeepCollectionEquality().hash(rolesSuffix),birthday);

@override
String toString() {
  return 'UsersPatchDto(password: $password, email: $email, emailVisibility: $emailVisibility, verified: $verified, name: $name, avatar: $avatar, roles: $roles, rolesRemovals: $rolesRemovals, rolesPrefix: $rolesPrefix, rolesSuffix: $rolesSuffix, birthday: $birthday)';
}
...
@useResult
$Res call({
 String? password, String? email, bool? emailVisibility, bool? verified, String? name, FileDto? avatar, List<RelationDto<RolesDto>>? roles, List<RelationDto<RolesDto>>? rolesRemovals, List<RelationDto<RolesDto>>? rolesPrefix, List<RelationDto<RolesDto>>? rolesSuffix, DateTime? birthday
});
...
/// Create a copy of UsersPatchDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? password = freezed,Object? email = freezed,Object? emailVisibility = freezed,Object? verified = freezed,Object? name = freezed,Object? avatar = freezed,Object? roles = freezed,Object? rolesRemovals = freezed,Object? rolesPrefix = freezed,Object? rolesSuffix = freezed,Object? birthday = freezed,}) {
