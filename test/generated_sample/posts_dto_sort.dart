...
class PostsDtoSort<D extends Dto<D>> extends DtoSortBase<D, PostsDto> {
  ...
  UsersDtoSort<PostsDto> get poster =>
      UsersDtoSort.from(addRelation(PostsDtoFieldEnum.poster));
  ...
  UsersDtoSort<PostsDto> get tagged =>
      UsersDtoSort.from(addRelation(PostsDtoFieldEnum.tagged));
