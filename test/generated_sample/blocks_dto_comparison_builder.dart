...
class BlocksDtoComparisonBuilder<D extends Dto<D>>
  ...
  UsersDtoComparisonBuilder<D> get blocker => UsersDtoComparisonBuilder(
    fieldPath.extend(BlocksDtoFieldEnum.blocker),
    handler,
  );
  UsersDtoComparisonBuilder<D> get blocked => UsersDtoComparisonBuilder(
    fieldPath.extend(BlocksDtoFieldEnum.blocked),
    handler,
  );
  TerminalRelationComparisonBuilder<D, BlocksTypeEnum> get type =>
...
class BlocksDtoMultirelComparisonBuilder<D extends Dto<D>>
  ...
  UsersDtoMultirelComparisonBuilder<D> get blocker =>
      UsersDtoMultirelComparisonBuilder(
        fieldPath.extend(BlocksDtoFieldEnum.blocker),
        handler,
      );
  UsersDtoMultirelComparisonBuilder<D> get blocked =>
      UsersDtoMultirelComparisonBuilder(
        fieldPath.extend(BlocksDtoFieldEnum.blocked),
        handler,
      );
  TerminalMultivalRelationComparisonBuilder<D, BlocksTypeEnum> get type =>
