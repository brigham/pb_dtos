...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FileDto&&(identical(other.name, name) || other.name == name));
}
